                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="<?=base_url("main/loginuser/2")?>" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Teacher Joanna</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?=base_url("main/loginuser/10")?>" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Admin</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
